...
space *do not upload these to the xviicoin.org server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the xviicoin.org server.

```

- Update xviicoin.org version

- Announce the release:

  - xviicoin-dev and xviicoin-dev mailing list

  - blog.xviicoin.org blog post
