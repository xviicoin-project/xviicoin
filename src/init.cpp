...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/xviicoin-project/xviicoin>";
    const std::string URL_WEBSITE = "<https://xviicoin.info>";
