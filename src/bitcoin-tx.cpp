...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s xviicoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  xviicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xviicoin transaction") + "\n" +
              "  xviicoin-tx [options] -create [commands]   " + _("Create hex-encoded xviicoin transaction") + "\n" +
              "\n";
