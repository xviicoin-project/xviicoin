...
const char * const BITCOIN_CONF_FILENAME = "xviicoin.conf";
const char * const BITCOIN_PID_FILENAME = "xviicoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "XVIIcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/XVIIcoin";
#else
    // Unix
    return pathRet / ".xviicoin";
#endif
#endif
}
